...
export default function RegisterPage() {
  ...
  async function register(ev) {
    ...
    const response = await fetch(
      "https://basic-authentification-api.vercel.app/register",
      {
        method: "POST",
  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center p-8">
      <form className="mt-8 max-w-lg w-96" onSubmit={register}>
        <h1 className="px-8 my-2 text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
          Quik Note:{" "}
          <span className=" text-base">
            there is no email verification, you can use any email you want to
            register
          </span>
        </h1>
